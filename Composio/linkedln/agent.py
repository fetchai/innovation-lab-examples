...
class LinkedInAgent:
    def __init__(self, user_id: str, auth_config_id: str):
        ...
        self.connected_account: Optional[Any] = None
        self.connection_request: Optional[Any] = None
...
if not LINKEDIN_AUTH_CONFIG_ID:
    print(
        "⚠️  LINKEDIN_AUTH_CONFIG_ID is not set. Copy .env.example to .env and "
        "fill it in, or authentication will fail with an unhelpful Composio error."
    )
