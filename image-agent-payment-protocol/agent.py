...
from payment_proto import payment_proto, set_agent_wallet  # noqa: E402
...
async def startup(ctx: Context):
    ...
    if skyfire_configured:
        ...
        ctx.logger.info(
            "   • Skyfire USDC: Not configured (set SKYFIRE_API_KEY and SKYFIRE_SERVICE_ID)"
        )
