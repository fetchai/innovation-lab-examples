...
def get_weather(city: str, units: str = "fahrenheit") -> dict:
    ...
    temp = weather["temp"]
    if units == "celsius":
        temp = round((float(str(temp)) - 32) * 5 / 9, 1)
        unit_symbol = "°C"
    else:
        unit_symbol = "°F"
...
def get_current_time(timezone: str = "UTC") -> dict:
    ...
    try:
        ...
        return {"timezone": timezone, "error": str(e), "success": False}
    ...
    mock_results = [
        {
            ...
            "url": f"https://example.com/result1",  # noqa: F541
        },
        {
            "title": f"Result 2 for '{query}'",
            "snippet": f"Another great source discussing {query} in detail...",
            "url": f"https://example.com/result2",  # noqa: F541
        },
        {
            "title": f"Result 3 for '{query}'",
            "snippet": f"Comprehensive guide to {query} with examples...",
            "url": f"https://example.com/result3",  # noqa: F541
        },
    ]
